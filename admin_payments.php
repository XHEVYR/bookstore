...
$query = "SELECT orders.*, users.username, receipts.image_path FROM orders INNER JOIN users ON orders.user_id = users.id LEFT JOIN receipts ON orders.id = receipts.order_id";
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($payment['image_path'])): ?>
                                 <img src="<?php echo $payment['image_path']; ?>" alt="Nota Pembayaran">
                                    <?php else: ?>
                                    <p>Tidak ada nota pembayaran.</p>
                                 <?php endif; ?>
                                </td>
